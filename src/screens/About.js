...
import {ScrollView, View, Image, Text, TextInput, LogBox} from 'react-native';
        ...
        <View style={{marginBottom: heightToDp((number = 1))}}>
          <View>
            ...
            <Text
              style={{
                ...
                color: 'white',
                marginTop: widthToDp((number = 2)),
                fontFamily: 'sans-serif-light',
                fontSize: widthToDp((number = 4.4)),
              }}>
              {about?.why}
            </Text>
          </View>
          ...
          <View>
            {products
              ...
              .map(c => {
                return (
                  <About1 imgsrc={c.imgsrc} product={c.product} link={c.link} />
                );
              })}
          </View>
        </View>
        ...
        <View>
          ...
          <View>
            {service1
              ...
              .map(c => {
                return (
                  <About2 imgsrc={c.imgsrc} serve={c.serve} link={c.link} />
                );
              })}
          </View>
